...
public class Category implements Content, Serializable
{
	...
	public Category(String id, String name, String imgurl, String about, Float discount,
			boolean parent, List<Category> subCategory, Long version, Date createdDate, Date lastModifiedDate,
			Boolean active) {
		super();
		this.id = id;
		this.name = name;
